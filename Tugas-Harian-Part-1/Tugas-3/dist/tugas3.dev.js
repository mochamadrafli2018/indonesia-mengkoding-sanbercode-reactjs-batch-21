...
console.log(kataPertama + " " + capitalizeTheFirstLetter(kataKedua) + " " + kataKetiga + " " + kataKeempat.toUpperCase()); //Soal 2
...
console.log('Kata Kelima: ' + kataKelima); //Soal 4
